...
(function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			_this.checkDataType();
			_this.renderWheels(_this.wheelsData, config.cancelBtnText, config.ensureBtnText, config.carrier);
		    ...
		    _this.trigger.addEventListener('click',function(){
				...
				if(_this.mobileSelect.classList.value=='mobileSelect'){
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText, carrier){
			var _this = this;
			...
			if(carrier){
				...
				$(carrier).append(_this.mobileSelect)
			}else {
